        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_pdf.php?tanggal_awal=<?php echo $tgl1 ?>&tanggal_akhir=<?php echo $tgl2 ?>&divisi=<?php echo $divisi ?>&sumberdana=<?php echo $dana ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
              <br><br>
