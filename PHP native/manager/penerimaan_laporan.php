        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            ?>
              ...
              <a href="penerimaan_laporan_pdf.php?tanggal_awal=<?php echo $tgl1 ?>&tanggal_akhir=<?php echo $tgl2 ?>&metode=<?php echo $metode ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
              <br><br>
