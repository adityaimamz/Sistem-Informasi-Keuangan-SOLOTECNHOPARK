...
if($filename == ""){
	mysqli_query($koneksi, "update master_barang set Kode_barang='$kode_barang',Nama_barang='$nama_barang',Lokasi='$lokasi', Tanggal='$tanggal',Id_divisi='$divisi' where Id_barang='$id'") or die(mysqli_error($koneksi));
