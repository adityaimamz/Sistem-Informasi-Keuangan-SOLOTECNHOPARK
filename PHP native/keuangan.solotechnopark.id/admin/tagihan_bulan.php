            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $no=1;
                  $bulan = date('m');
                  $data = mysqli_query($koneksi,"SELECT master_penerimaan.* FROM master_penerimaan WHERE master_penerimaan.Status='voice' AND MONTH(master_penerimaan.Tanggal)='$bulan' order by Id_penerimaan desc");
