            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $no=1;
                  $tahun = date('Y');
                  $data = mysqli_query($koneksi,"SELECT master_penerimaan.* FROM master_penerimaan WHERE master_penerimaan.Status='voice' AND YEAR(master_penerimaan.Tanggal)='$tahun'  order by Id_penerimaan desc");
