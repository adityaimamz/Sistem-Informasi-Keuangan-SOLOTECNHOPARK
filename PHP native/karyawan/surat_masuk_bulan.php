      ...
      <section class="col-lg-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Daftar Surat Masuk <?php echo "(".$namabulan[$bulan_ini]. ")";?></h3>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $no=1;
                  $bulan = date('m');
                  $data = mysqli_query($koneksi,"SELECT surat_masuk.* FROM surat_masuk WHERE MONTH(surat_masuk.Tanggal)='$bulan' ORDER BY surat_masuk.Id_Suratmasuk DESC");
