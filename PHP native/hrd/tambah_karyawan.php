              ...
              <div class="tab-pane" id="pelatihan">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="tanggal" required="required" class="form-control datepicker2" placeholder="Tanggal Lulus">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
              ...
              <div class="tab-pane" id="hukuman">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="tanggal" required="required" class="form-control datepicker2" placeholder="Tanggal SK">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
              ...
              <div class="tab-pane" id="cuti">
                  <form class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="tanggal" required="required" class="form-control datepicker2"  placeholder="Tanggal Mulai Cuti">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputTanggalSelesaiCuti" class="col-sm-2 control-label">Tanggal Selesai Cuti</label>
                      <div class="col-sm-10">
                        <input type="text" name="tanggal" required="required" class="form-control datepicker2"  placeholder="Tanggal Selesai Cuti">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
              ...
              <div class="active tab-pane" id="ortu">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="tanggal" required="required" class="form-control datepicker2" placeholder="Tanggal Lahir Ayah">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="tanggal" required="required" class="form-control datepicker2" placeholder="Tanggal Lahir Ibu">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
