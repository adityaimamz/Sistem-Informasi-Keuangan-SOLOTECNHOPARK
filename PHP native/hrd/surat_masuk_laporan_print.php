...
<!DOCTYPE html>
 ...
 <head>
 	...
 	<title>Laporan Surat Masuk UPTD Kawasan Sains Dan Teknologi Solo Technopark</title>
 ...
 <body>
	<div class="kop-surat">
		...
		<div class="judul-laporan">
			...
			<h4 style="margin-top:3px;">Rekap Surat Masuk Online UPTD Kawasan Sains Dan Teknologi Solo Technopark</h4>
 				...
 				<thead>
 					<tr>
                        ...
                        <th width="10%" rowspan="2" class="text-center">TANGGAL</th>
 						<th width="10%" rowspan="2" class="text-center">NOMOR SURAT MASUK</th>
 						<th rowspan="2" class="text-center">NOMOR SURAT</th>
 						<th rowspan="2" class="text-center">TERIMA DARI</th>
