...
$tempatLahirAyahMertua = $_POST['tempatlahirayahmertua'];
$tanggalLahirAyahMertua = $_POST['tgllahirayahmertua'];
$namaIbuMertua = $_POST['namaibumertua'];
$tempatLahirIbuMertua = $_POST['tempatlahiribumertua'];
$tanggalLahirIbuMertua = $_POST['tgllahiribumertua'];
...
mysqli_query($koneksi, "INSERT INTO riwayat_keluarga values ('NULL','$karyawan', '$namaAyah', '$tempatLahirAyah', '$tanggalLahirAyah', '$namaIbu', '$tempatLahirIbu', '$tanggalLahirIbu', '$namaPasangan', '$tempatLahirPasangan', '$tanggalLahirPasangan', '$namaAyahMertua', '$tempatLahirAyahMertua', '$tanggalLahirAyahMertua','$namaIbuMertua', '$tempatLahirIbuMertua', '$tanggalLahirIbuMertua', '$namaAnak1', '$tempatLahirAnak1', '$tanggalLahirAnak1', '$namaAnak2', '$tempatLahirAnak2', '$tanggalLahirAnak2', '$namaAnak3', '$tempatLahirAnak3', '$tanggalLahirAnak3', '$namaAnak4', '$tempatLahirAnak4', '$tanggalLahirAnak4', '$namaAnak5', '$tempatLahirAnak5', '$tanggalLahirAnak5')")or die(mysqli_error($koneksi));
