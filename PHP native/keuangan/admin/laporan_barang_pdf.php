...
$pdf->Cell(50,8,'Lokasi',1,0,'C',1);
$pdf->Cell(50,8,'Nama Divisi',1,0,'C',1);
...
$pdf->Cell(50,8,$row['Lokasi'],1,0,'C',0);
$pdf->Cell(50,8,$row['Nama_divisi'],1,0,'C',0);
$pdf->Cell(50,8,$row['Tanggal'],1,0,'C',0);
