      ...
      <section class="col-lg-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Daftar Surat Keluar <?php echo "(".$namabulan[$bulan_ini]. ")";?></h3>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $no=1;
                  $bulan = date('m');
                  $data = mysqli_query($koneksi,"SELECT surat_keluar.* FROM surat_keluar WHERE MONTH(surat_keluar.Tanggal)='$bulan' ORDER BY surat_keluar.id_Suratkeluar DESC");
