      ...
      <section class="col-lg-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Daftar Surat Masuk <?php echo date('d-m-Y', strtotime($tanggal));?></h3>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT surat_masuk.* FROM surat_masuk WHERE surat_masuk.Tanggal='$tanggal' ORDER BY surat_masuk.Id_Suratmasuk DESC");
