                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    while($d = mysqli_fetch_array($data)){
                      ...
                      <td>
                          <button title="Edit" type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_Suratkeluar<?php echo $d['Id_Suratkeluar'] ?>">
                            <i class="fa fa-cog"></i>
                          </button>

                          <button title="Hapus" type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_Suratkeluar<?php echo $d['Id_Suratkeluar'] ?>">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group" style="width:100%;margin-bottom:20px">
                                      <label>Nomor Suratkeluar</label>
                                      <input type="text" style="width:100%" name="Nomor_Suratkeluar"  class="form-control" value="<?php echo $d['Kode_Suratkeluar'] ?>" >
                                    </div>
                          ...
                          <!-- Modal Hapus -->
                          <div class="modal fade" id="hapus_Suratkeluar<?php echo $d['Id_Suratkeluar'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
