    ...
    <div class="login-box">
      ...
      <center>
        ...
        if (isset($_GET['alert'])) {
          ...
          }else if ($_GET['alert'] == "cobalagi") {
            echo "<div class='alert alert-warning'>COBA LAGI</div>";
          }
        }
        ?>
      </center>
      ...
      <div class="login-box-body">
        ...
        <div class="text-center"> <img src="/keuanganCoba/assets/logo.ico" style="max-width:30%;">
          <br>
